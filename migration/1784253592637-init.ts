...
export class Init1784253592637 implements MigrationInterface {
    name = 'Init1784253592637'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "violation_types" ADD CONSTRAINT "FK_265abd4d92f6ecf0dfbf2c6ff2c" FOREIGN KEY ("school_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "loggers" ADD CONSTRAINT "FK_13849a49640d6a5834c2e766906" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "image_links" ADD CONSTRAINT "FK_65c8c56b354618d3ca9d56f8634" FOREIGN KEY ("violation_id") REFERENCES "violations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "violations" ADD CONSTRAINT "FK_3547507f7a3608aa988f3dd91a5" FOREIGN KEY ("school_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "violations_violation_types_violation_types" ADD CONSTRAINT "FK_14c78d3c46cb81b451d9ccf6fe5" FOREIGN KEY ("violation_types_id") REFERENCES "violation_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
